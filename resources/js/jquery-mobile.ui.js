...
var sidebar = {};
var nav_width = $('.nav_side').width();
$('.service_new').css('width',nav_width);
...
$(".btnZone .btns_wrap .btn").click(function () {
	$('.ui-detail-optbox').css("max-height","440px");
});
...
var goods = {
	    optionBox: {
	        ...
	        open: function(){
	            ...
	            this.optBox.css('max-height', 440+'px');
	            this.buyBtn.hide();
	            this.orderBtn.show();
	            this.cartBtn.hide();
	            this.gocartBtn.show();
	        ...
	        hideBox: function(){
	            this.optionWrap.css({'transition-duration':'0ms'}).css({'bottom':'-440px'});
	        },
...
var float_header = {
	...
	side_open: function(){
    $('.header').addClass('sopen');
    $('.header').removeClass('fixed');
    $('.header_wrap').removeClass('w100');
	...
	side_close: function(){
    $('.header').removeClass('sopen');
    $('.header').addClass('fixed');
    $('.header_wrap').addClass('w100');
		$('.dim').hide();
		$(window).scrollTop(0);
